...
class MWS(object):
    ...
    def __init__(self, access_key, secret_key, account_id, auth_token, region='IN', domain='', uri="", version=""):
    ...
    def make_request(self, extra_data, method="POST", **kwargs):
        ...
        headers = {'User-Agent': 'python-amazon-mws/0.0.1 (Language=Python)', 'Content-Type': 'text/xml'}
        ...
        try:
            ...
            response = urllib2.urlopen(request, data=kwargs.get('body', '')).read()
            data = response
    ...
    def calc_signature(self, method, request_description):
        ...
        return base64.b64encode(hmac.new(str(self.secret_key), sig_data, hashlib.sha256).digest()).decode()  ####did change decode()
...
class Feeds(MWS):
    ...
    def submit_feed(self, feed, feed_type, marketplaceids=None,content_type="text/xml", purge='false'):
        """
    ...
    def get_feed_submission_list(self, feedids=None, max_count=None, feedtypes=None,processingstatuses=None, fromdate=None, todate=None):
        """
...
class Reports(MWS):
    ...
    def get_report_list(self, requestids=(), max_count=None, types=(), acknowledged=None, fromdate=None, todate=None):
    ...
    def get_report_request_list(self, requestids=(), types=(), processingstatuses=(), max_count=None, fromdate=None, todate=None):
    ...
    # def UpdateReportAcknowledgements
    # def CancelReportRequests
    # def ManageReportSchedule
    # def GetReportScheduleListByNextToken
...
class Orders(MWS):
    ...
    def list_orders(self, marketplaceids, created_after=None, created_before=None, lastupdatedafter=None,lastupdatedbefore=None, orderstatus=(), fulfillment_channels=(),payment_methods=(), buyer_email=None, seller_orderid=None, max_results='100'):
